...
<body>
	...
	<div class="container pt-3">
		...
		<div class="mb-3">
			<p>${journalEntry.game.gameTitle }</p>
			<div class="card w-50">
				...
				<div class="card-body">
					...
					<p>
						Created by:
						${ user.id == journalEntry.user.id ? "You" : user.userName }
					</p>
					<p>
						Updated At: ${journalEntry.updatedAt }
					</p>
				</div>
			</div>
		...
		<div class="w-50 d-flex justify-content-end">
			<a class="btn btn-outline-dark me-3" href="/journal/edit/${journalEntry.id }">
				Edit
			</a>
