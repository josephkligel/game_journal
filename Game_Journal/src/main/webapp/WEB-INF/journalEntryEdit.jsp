	...
	<div class="container pt-3">
		...
		<div class="w-75">
			<p class="text-center">Edit an Entry</p>
				...
				<form:form action="/journal/update" method="post" modelAttribute="journalEntry">
														
					<input type="hidden" name="_method" value="put" />
					<form:input type="hidden" value="${journalEntry.id }" path="id" />
					<form:input type="hidden" value="${journalEntry.user.id }" path="user" />
